 ...
 * 
 * @description
 * GroupMenuPage: GroupMenuPage component for listing group menu
 * @return GroupMenuPage component
 */
const GroupMenuPage = () => {
