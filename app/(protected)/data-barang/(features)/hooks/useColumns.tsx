 ...
 * 
 * @description
 * useColumns: useColumns hook for DataBarangPage
                ...
                cell: (info) => {
                    ...
                    return (
                        <div className="flex flex-row gap-x-2">
                            {checkPermissions(['master.barang.update'], permissions) && (
                                <Button
                                    onClick={() => {
                                        router.push(`/data-barang/edit-data/${row.id}`)
                                    }}
                            ...
                            {checkPermissions(['master.barang.delete'], permissions) && (
                                <Button
                                    onClick={() => {
                                        setSelectedRow({
                                            name: row.nama,
