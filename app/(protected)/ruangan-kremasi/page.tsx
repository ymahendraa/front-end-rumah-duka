 ...
 * 
 * @description
 * RuanganKremasiPage: RuanganKremasiPage component for showing almarhum data
 * @return RuanganKremasiPage component
 */
const RuanganKremasiPage = () => {
...
export default RuanganKremasiPage